      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
		...
		<div class="form-panel">
		    <h3><a href="javascript:history.back()"><i class="fa fa-arrow-left" aria-hidden="true"></i></a> &nbsp&nbsp <i class="fa fa-university" aria-hidden="true"></i> Detalhes  <span class="hidden-phone">da Instituição</span>
		    <a href="AtualizaInstituicao?inst_id=${instituicao.id}" type="button" class="btn btn-primary pull-right" style="margin-right:10px;"><i class="fa fa-pencil fa-lg" aria-hidden="true"></i> <span class="hidden-phone">&nbsp&nbsp&nbsp Atualizar Instituição</span></a>
		    </h3>
