			...
			<form class="form-horizontal style-form" action="cadastrarEquipe" method = "post">	
			      ...
			      <div class="col-md-3">
			        <div class="text-center">
			          ...
			          <h6>Preencha o máximo possível!</h6> 			          
			        </div>
			      </div>
		      ...
		      <div class="col-md-8 personal-info ">
		          <div class="form-group">  
		            <label class="col-sm-2 col-sm-2 control-label"><b>Diretoria Responsável</b></label>
		              <div class="col-sm-10">
		              <select class="form-control" name = "diretoria"  required>
							  ...
							  <option>Diretoria de Comunicação</option>
		                </select> 
		              </div>
		          </div>
		          <div class="form-group">  
		          ...
		          <div class="form-group">  
		            <label class="col-sm-2 col-sm-2 control-label"><b>Númeto de Membros</b></label>
		              <div class="col-sm-10">
