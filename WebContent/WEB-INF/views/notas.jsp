      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">                               
			...
			<h3><a href="javascript:history.back()"><i class="fa fa-arrow-left" aria-hidden="true"></i></a> Título: ${demanda.titulo}</h3>
				<div class="row">
				
	                  <div class="col-md-12 mt">
	                  	<div class="content-panel">
	                          <table class="table table-hover"> 
	                  	  	  <h4><i class="fa fa-angle-right"></i> <b>Descrição:</b> ${demanda.descricao}</h4>
	                  	  	  <hr>
	                              <thead>
	                              <tr>
	                                  <th>Tipo</th>
	                              ...
	                              <tbody>
		                              <c:forEach items="${demanda.notas}" var="nota">
			                              <tr>
			                                  <td><span style="background-color:<c:out value="${nota.getHexCor()}"/>" class="label">${nota.getTipoTexto()}</span></td>
			                                  <td>${nota.data_de_criacao}</td>
			                                  <td>${nota.nome_criador}</td>
			                                  <td>${nota.nota}</td>
			                              </tr>
		                              </c:forEach>	                          
	                              </tbody>
