		...
		<div class="form-panel">
			...
			<form class="form-horizontal style-form" action="atualizaInfo" method = "post">	
		      ...
		      <div class="col-md-8 personal-info ">
		          ...
		          <div class="form-group">  
		            <label class="col-sm-2 col-sm-2 control-label"><b>EndereÁo</b></label>
		              <div class="col-sm-10">
		              <input name = "endereco" class="form-control" value="${voluntario.endereco}" type="text" placeholder = "EndereÁo Vazio">
		              </div>
		          </div>
		          <div class="form-group">  
		            <label class="col-sm-2 col-sm-2 control-label"><b>Regi„o</b></label>
		              ...
		              <select class="form-control" id="regiao" name = "regiao"  required>
								<option value="" >Cidade SatÈlite*</option>							
		          ...
		          <div class="form-group">
		            <label class="col-md-2 control-label"></label>
		              ...
		              <input class="btn btn-primary" value="Atualizar InformaÁıes" type="submit">
		              <span></span>
