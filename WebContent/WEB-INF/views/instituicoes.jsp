                      ...
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
                              ...
                              <tr>
	                              ...
	                              <a style="font-size:13px;"  class="btn btn-primary btn-xs fa fa-arrow-circle-down"></a>
								  <div class="dropdown-content">
								  	<c:forEach items="${instituicao.caracteristicas()}" var="tag">
								  	  <a><span class="label label-default">${tag.nome}</span></a>
								    </c:forEach>
								  </div>
								</div></td>
								<td><div class="dropdown">
	                              ...
	                              <td>${instituicao.ra.nome}</td>
	                              <td><a onclick="clickAndDisable(this);" href="DetalheInstituicao?inst_id=${instituicao.id}"style="font-size:13px;"  class="btn btn-primary btn-xs fa fa-info-circle"></a></td>
                              </tr>   
                              </c:forEach>                          
                              </tbody>
                          </table>
