                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
                              ...
                              <tbody>
                              <c:forEach items="${diretores}" var="diretor" varStatus="loop" >
                              <tr>
                              	  <td>${diretor.diretoria.nome}</td>
                                  <td>${diretor.nome}</td>
                                  <td>${diretor.whatsapp}</td>
                                  <td class="hidden-phone">${diretor.email}</td>
                                  <td class="hidden-phone">${diretor.regiao.nome}</td>
                                  <td>
                                      <button data-toggle="modal" href="#ModalRetirar" onclick="modalRetirar(${diretor.id});" class="btn btn-danger btn-xs" style="margin-left:10px;"><i class="fa fa-times "></i></button>
                                  </td>
                              </tr>   
                              </c:forEach>                          
                              </tbody>
			...
			<!-- Modal -->
					...
					<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="ModalRetirar" class="modal fade">
		              <div class="modal-dialog">
		                  <div class="modal-content">
		                      ...
		                      <form action="retirarDiretor" method="post">
		                      <div class="modal-footer">
		         ...
		         <!-- Modal -->
					<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="AddRecursoHumano" class="modal fade">
		              <div class="modal-dialog">
		              <form class="form-horizontal style-form" action="adicionarDiretor"  method="post">
		                  <div class="modal-content">
		                      <div class="modal-header">
		                          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
						            ...
						            <label class="col-sm-2 col-sm-2 control-label"><b>Diretoria</b></label>
						              <div class="col-sm-10">
						              	<select class="form-control" name = "diretoria" required>
				                      	  <option value="" ></option>	
				                      	  <c:forEach items="${diretorias}" var="dir" >		
										   <option value="${dir.id}">${dir.nome}</option>
										   </c:forEach>
										</select>						             
						              </div>
						          </div>						          						      		                      
